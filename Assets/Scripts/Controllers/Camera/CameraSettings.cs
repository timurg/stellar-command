...
public class CameraSettings : MonoBehaviour
{
    ...
    [SerializeField] private float referenceHeight = 1080f; // Reference resolution height (e.g., 1080p)
    [SerializeField] private const float PPI_ADJUSTMENT = 100f; // Keep for compatibility, but adjust logic
